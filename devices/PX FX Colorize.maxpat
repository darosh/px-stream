{
  "patcher": {
    ...
    "parameters": {
      "obj-100": ["Min", "live.numbox", 0],
      "obj-104": ["Falloff", "live.numbox", 0],
      "obj-105": ["OKLAB", "live.text", 0],
      "obj-106": ["Mix", "live.numbox", 0],
      "obj-107": ["Luminosity", "live.numbox", 0],
      "obj-110": ["Invert", "live.text", 0],
      "obj-111": ["Blend", "live.text", 0],
      "obj-112": ["Mapping", "live.menu", 0],
      "obj-113": ["Phase", "live.numbox", 0],
      "obj-116": ["Scale", "live.numbox", 0],
      "obj-117": ["Mirror", "live.text", 0],
      "obj-118": ["Levels", "live.numbox", 0],
      "obj-13": ["Color 1G", "live.numbox", 0],
      "obj-14": ["Color 1B", "live.numbox", 0],
      "obj-33": ["Color 1", "live.button", 0],
      "obj-366": ["Channel", "Channel", 0],
      "obj-4": ["Color 1R", "live.numbox", 0],
      "obj-54": ["Color 2", "live.button", 0],
      "obj-59": ["Color 2B", "live.numbox", 0],
      "obj-60": ["Color 2G", "live.numbox", 0],
      "obj-61": ["Color 2R", "live.numbox", 0],
      "obj-68": ["Color 3", "live.button", 0],
      "obj-73": ["Color 3B", "live.numbox", 0],
      "obj-74": ["Color 3G", "live.numbox", 0],
      "obj-75": ["Color 3R", "live.numbox", 0],
      "obj-79": ["Position", "live.numbox", 0],
      "obj-82": ["Width", "live.numbox", 0],
      "obj-83": ["3 Colors", "live.text", 0],
      "obj-87": ["More", "live.text", 0],
      "obj-90": ["Smoothing", "live.numbox", 0],
      "obj-91": ["Curve", "Curve", 0],
      "obj-94": ["Offset", "Offset", 0],
      "obj-97": ["Max", "live.numbox", 0],
      "parameterbanks": {
        "0": {
          "index": 0,
          "name": "",
