...
<!-- begin: collage -->
<div>
    <a href="#px-mix-view"><img src="./docs/media/devices/PX_Mix_View_(expanded).webp" title="PX Mix View" width="278"/></a>
    <a href="#dev-info"><img src="./docs/media/devices/DEV_Info.webp" title="DEV Info" width="100"/></a>
    <a href="#px-mix-channel"><img src="./docs/media/devices/PX_Mix_Channel.webp" title="PX Mix Channel" width="59"/></a>
    <a href="#in-mix"><img src="./docs/media/devices/PX_IN_Mix.webp" title="IN Mix" width="59"/></a>
    <a href="#fx-transform"><img src="./docs/media/devices/PX_FX_Transform.webp" title="FX Transform" width="59"/></a>
    <a href="#fx-blur"><img src="./docs/media/devices/PX_FX_Blur.webp" title="FX Blur" width="59"/></a>
    <a href="#px-route-audio"><img src="./docs/media/devices/PX_Route_Audio.webp" title="PX Route Audio" width="48"/></a>
    <a href="#fx-pixelization"><img src="./docs/media/devices/PX_FX_Pixelization.webp" title="FX Pixelization" width="116"/></a>
    <a href="#fx-color"><img src="./docs/media/devices/PX_FX_Color_(hue).webp" title="FX Color" width="208"/></a>
    <a href="#px-follow"><img src="./docs/media/devices/PX_Follow.webp" title="PX Follow" width="48"/></a>
    <a href="#dev-console"><img src="./docs/media/devices/DEV_Console.webp" title="DEV Console" width="53"/></a>
    <a href="#fx-delay"><img src="./docs/media/devices/PX_FX_Delay.webp" title="FX Delay" width="59"/></a>
    <a href="#in-cam"><img src="./docs/media/devices/PX_IN_Cam.webp" title="IN Cam" width="59"/></a>
    <a href="#in-stream"><img src="./docs/media/devices/PX_IN_Stream_(Spout).webp" title="IN Stream" width="59"/></a>
    <a href="#px-mix-grid"><img src="./docs/media/devices/PX_Mix_Grid.webp" title="PX Mix Grid" width="59"/></a>
    <a href="#fx-alpha"><img src="./docs/media/devices/PX_FX_Alpha.webp" title="FX Alpha" width="96"/></a>
    <a href="#fx-color"><img src="./docs/media/devices/PX_FX_Color_(gamma).webp" title="FX Color" width="133"/></a>
    <a href="#px-shader"><img src="./docs/media/devices/PX_Shader_(types).webp" title="PX Shader" width="133"/></a>
    <a href="#px-rec"><img src="./docs/media/devices/PX_Rec.webp" title="PX Rec" width="48"/></a>
    <a href="#px-world"><img src="./docs/media/devices/PX_World.webp" title="PX World" width="53"/></a>
    <a href="#fx-kaleidoscope"><img src="./docs/media/devices/PX_FX_Kaleidoscope.webp" title="FX Kaleidoscope" width="59"/></a>
    <a href="#in-channel"><img src="./docs/media/devices/PX_IN_Channel.webp" title="IN Channel" width="59"/></a>
    <a href="#in-stream"><img src="./docs/media/devices/PX_IN_Stream_(Syphon).webp" title="IN Stream" width="59"/></a>
    <a href="#px-mix-transition"><img src="./docs/media/devices/PX_Mix_Transition.webp" title="PX Mix Transition" width="59"/></a>
    <a href="#gen-sketching"><img src="./docs/media/devices/PX_GEN_Sketching.webp" title="GEN Sketching" width="100"/></a>
    <a href="#px-shader"><img src="./docs/media/devices/PX_Shader.webp" title="PX Shader" width="203"/></a>
    <a href="#fx-color"><img src="./docs/media/devices/PX_FX_Color.webp" title="FX Color" width="138"/></a>
    <a href="#px-sync"><img src="./docs/media/devices/PX_Sync_(expanded).webp" title="PX Sync" width="117"/></a>
    <a href="#fx-colorize"><img src="./docs/media/devices/PX_FX_Colorize.webp" title="FX Colorize" width="96"/></a>
    <a href="#px-mix-dry"><img src="./docs/media/devices/PX_Mix_Dry.webp" title="PX Mix Dry" width="59"/></a>
    <a href="#in-svg"><img src="./docs/media/devices/PX_IN_SVG.webp" title="IN SVG" width="59"/></a>
    <a href="#gen-text"><img src="./docs/media/devices/PX_GEN_Text.webp" title="GEN Text" width="59"/></a>
    <a href="#fx-convert"><img src="./docs/media/devices/PX_FX_Convert.webp" title="FX Convert" width="59"/></a>
    <a href="#px-route-midi"><img src="./docs/media/devices/PX_Route_MIDI_(linked).webp" title="PX Route MIDI" width="48"/></a>
    <a href="#gen-cos-pattern"><img src="./docs/media/devices/PX_GEN_Cos_Pattern.webp" title="GEN Cos Pattern" width="138"/></a>
    <a href="#px-follow"><img src="./docs/media/devices/PX_Follow_(expanded).webp" title="PX Follow" width="137"/></a>
    <a href="#px-sync"><img src="./docs/media/devices/PX_Sync.webp" title="PX Sync" width="48"/></a>
    <a href="#px-world"><img src="./docs/media/devices/PX_World_(mad_world).webp" title="PX World" width="53"/></a>
    <a href="#fx-pass"><img src="./docs/media/devices/PX_FX_Pass.webp" title="FX Pass" width="59"/></a>
    <a href="#in-image"><img src="./docs/media/devices/PX_IN_Image.webp" title="IN Image" width="59"/></a>
    <a href="#in-video"><img src="./docs/media/devices/PX_IN_Video.webp" title="IN Video" width="59"/></a>
    <a href="#gen-mini-shader"><img src="./docs/media/devices/PX_GEN_Mini_Shader.webp" title="GEN Mini Shader" width="100"/></a>
    <a href="#gen-text"><img src="./docs/media/devices/PX_GEN_Text_(expanded).webp" title="GEN Text" width="114"/></a>
    <a href="#px-mix-view"><img src="./docs/media/devices/PX_Mix_View.webp" title="PX Mix View" width="144"/></a>
</div>
<!-- end: collage -->
...
0. Prerequisites: _Ableton Live 12.2 Suite_ or _Ableton Live 12.2 Standard with Max for Live_ (bundled Max version 9.0.7, and up to 9.0.9 should work, the latest 9.1.0 might have breaking changes)
...
<img src="./docs/media/guide/Using_Mix_Dry_v1.webp" height="127" title="Using Mix Dry" />
...
<img src="./docs/media/guide/Using_MIDI.webp" height="127" title="Using MIDI" />
...
<img src="./docs/media/guide/Using_Feedback_v2.webp" height="127" title="Using Feedback" />
...
<img src="./docs/media/guide/Using_XY_Oscilloscope_v2.webp" height="127" title="Using XY Oscilloscope" />
...
<img src="./docs/media/guide/Syphon_streaming.webp" height="127" title="Syphon/Spout streaming" />
...
<img src="./docs/media/devices/PX_Follow.webp" height="231" title="PX Follow" /> <img src="./docs/media/devices/PX_Follow_(expanded).webp" height="231" title="PX Follow (expanded)" />
...
<img src="./docs/media/devices/PX_Sync.webp" height="231" title="PX Sync" /> <img src="./docs/media/devices/PX_Sync_(expanded).webp" height="231" title="PX Sync (expanded)" />
