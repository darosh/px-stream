...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1224.0, 712.0, 71.0, 22.0 ],
					"text" : "s ---to_grab"
				}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_enum" : [ " ", "<none>", "FaceTime HD Camera", "Elgato Virtual Camera", "OBS Virtual Camera" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.0, 528.0, 75.0, 23.0 ],
					"text" : "t getvdevlist"
				}
