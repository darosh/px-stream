...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 8.0, 326.0, 552.0 ],
					"suppressinlet" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 656.0, 8.0, 57.0, 65.0 ],
					"suppressinlet" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 368.0, 560.0, 49.0, 65.0 ],
					"suppressinlet" : 1,
					"text" : "To types menu",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 512.0, 560.0, 56.0, 65.0 ],
					"suppressinlet" : 1,
...
,
					"patching_rect" : [ 720.0, 344.0, 101.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 448.0, 200.0, 212.0, 50.0 ],
					"suppressinlet" : 1,
...
,
					"patching_rect" : [ 720.0, 464.0, 153.0, 22.0 ],
					"saved_object_attributes" : 					{
						"editing_bgcolor" : [ 0.56078431372549, 0.56078431372549, 0.56078431372549, 1.0 ],
						"locked_bgcolor" : [ 0.56078431372549, 0.56078431372549, 0.56078431372549, 1.0 ]
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 664.0, 256.0, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 752.0, 216.0, 83.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "clear" ],
					"patching_rect" : [ 664.0, 464.0, 41.0, 22.0 ],
					"text" : "t clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 664.0, 296.0, 74.0, 22.0 ],
					"text" : "sel <empty>"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 664.0, 128.0, 156.0, 22.0 ],
					"text" : "unpack s 0"
				}
...
,
					"patching_rect" : [ 520.0, 464.0, 111.0, 22.0 ],
					"saved_object_attributes" : 					{
						"editing_bgcolor" : [ 0.56078431372549, 0.56078431372549, 0.56078431372549, 1.0 ],
						"locked_bgcolor" : [ 0.56078431372549, 0.56078431372549, 0.56078431372549, 1.0 ]
					}
...
,
					"patching_rect" : [ 376.0, 464.0, 92.0, 22.0 ],
					"saved_object_attributes" : 					{
						"editing_bgcolor" : [ 0.56078431372549, 0.56078431372549, 0.56078431372549, 1.0 ],
						"locked_bgcolor" : [ 0.56078431372549, 0.56078431372549, 0.56078431372549, 1.0 ]
					}
...
, 			{
				"box" : 				{
					"comment" : "(symbol, int) input or output DeviceIO type, channel index",
					"id" : "obj-19",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 664.0, 80.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 664.0, 168.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 664.0, 216.0, 77.0, 22.0 ],
					"saved_object_attributes" : 					{
						"_persistence" : 1
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 752.0, 256.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 408.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "From sources / targets umenu",
					"id" : "obj-93",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 376.0, 408.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "To sources / targets umenu",
					"id" : "obj-94",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 376.0, 520.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 520.0, 520.0, 30.0, 30.0 ]
				}
