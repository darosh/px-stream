...
void main()
{
    ...
    // Sample audio input
    float wave = IMG_NORM_PIXEL(waveImage, vec2(xWave * 0.2, 0.5)).r * sin(TIME * 0.2) * MUSIC_REACTION;
    float wave1 = IMG_NORM_PIXEL(waveImage, vec2(xWave * 0.2 + 0.2, 0.5)).r * sin(TIME * 0.2 + 0.5) * MUSIC_REACTION;
    float wave2 = IMG_NORM_PIXEL(waveImage, vec2(xWave * 0.2 + 0.4, 0.5)).r * sin(TIME * 0.2 + 1.0) * MUSIC_REACTION;
    float wave3 = IMG_NORM_PIXEL(waveImage, vec2(xWave * 0.2 + 0.6, 0.5)).r * sin(TIME * 0.2 + 1.5) * MUSIC_REACTION;
    float wave4 = IMG_NORM_PIXEL(waveImage, vec2(xWave * 0.2 + 0.8, 0.5)).r * sin(TIME * 0.2 + 2.0) * MUSIC_REACTION;
