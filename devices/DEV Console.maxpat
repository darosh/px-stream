{
  "patcher": {
    ...
    "boxes": [
      ...
      },
      {
        "box": {
          ...
          "numoutlets": 1,
          "outlettype": [""],
          "patching_rect": [160, 216, 156, 22],
          "text": "prepend script send conTab"
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "parameter_enable": 0,
          "patching_rect": [352, 264, 24, 24],
          "presentation": 1,
          "presentation_rect": [84, 0, 48, 48],
      ...
      },
      {
        "box": {
          ...
          "outlettype": ["", ""],
          "parameter_enable": 1,
          "patching_rect": [160, 80, 64, 15],
          "presentation": 1,
          "presentation_rect": [8, 16, 56, 15],
          "saved_attribute_attributes": {
            "valueof": {
          ...
          "texton": "Active",
          "varname": "live.text",
          "annotation": "Activates Max console additional output. May affect performance. DO NOT USE IN PRODUCTION.",
      ...
      },
      {
        "box": {
            ...
            "boxes": [
              {
                "box": {
                  ...
                  "numinlets": 1,
                  "numoutlets": 0,
                  "patching_rect": [0, 64, 520, 41],
                  "presentation": 1,
                  "presentation_rect": [-1, 39, 130, 41],
                  "text": "⌥⇧⌘M",
                  "textjustification": 1
                }
              },
              ...
              },
              {
                "box": {
                  ...
                  "numinlets": 1,
                  "numoutlets": 0,
                  "patching_rect": [136, 232, 128, 128],
                  "presentation": 1,
                  "presentation_rect": [0, 0, 130, 121],
                  "proportion": 0.39,
                  "rounded": 0,
                  "saved_attribute_attributes": {
          ...
          "patching_rect": [104, 416, 192, 128],
          "presentation": 1,
          "presentation_rect": [0, 48, 130, 121],
          "varname": "conTab",
          "viewvisibility": 1
        }
      },
    ...
    "lines": [
      ...
      {"patchline": {"destination": ["obj-8", 1], "source": ["obj-12", 0]}},
      {"patchline": {"destination": ["obj-3", 0], "source": ["obj-16", 0]}},
      {"patchline": {"destination": ["obj-15", 0], "source": ["obj-17", 0]}},
      {"patchline": {"destination": ["obj-7", 0], "source": ["obj-19", 0]}},
      {"patchline": {"destination": ["obj-2", 0], "source": ["obj-3", 0]}},
      {"patchline": {"destination": ["obj-16", 0], "source": ["obj-4", 0]}},
      {"patchline": {"destination": ["obj-19", 0], "source": ["obj-5", 0]}},
      {
        "patchline": {
