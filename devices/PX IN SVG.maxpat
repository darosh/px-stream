...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 504.0, 976.0, 213.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 968.0, 209.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1128.0, 968.0, 72.0, 22.0 ],
					"text" : "expr $f4/$f2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 616.0, 1040.0, 61.0, 22.0 ],
					"text" : "pack f f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.0, 1080.0, 72.0, 22.0 ],
					"text" : "$1 $2 $3 $4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.0, 1040.0, 61.0, 22.0 ],
					"text" : "pack f f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 968.0, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 784.0, 968.0, 146.0, 22.0 ],
					"text" : "expr max($f3/$f1\\, $f4/$f2)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 160.0, 63.0, 22.0 ],
					"text" : "types .svg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 832.0, 400.0, 208.0, 49.0 ],
...
,
			"parameter_overrides" : 			{
				"obj-4::obj-76" : 				{
					"parameter_invisible" : 2,
					"parameter_modmode" : 0,
					"parameter_range" : [ "L.1", "L.2", "L.3", "N.1", "N.2", "N.3", "N.4", "N.5", "PX.1 Logo", "PX.2 Made with", "T.1 TestScreen_square1", "T.2 TestScreen_Remix", "T.3 1291143713", "T.4 EIA1956", "T.5 Linear" ],
					"parameter_type" : 2,
