{
  "patcher": {
    ...
    "boxes": [
      ...
      },
      {
        "box": {
          ...
          "parameter_enable": 0,
          "patching_rect": [624, 496, 24, 24],
          "presentation": 1,
          "presentation_rect": [52, 74, 24, 24],
      ...
      },
      {
        "box": {
          ...
          "outlettype": ["", ""],
          "parameter_enable": 1,
          "patching_rect": [640, 288, 44, 15],
          "presentation": 1,
          "presentation_rect": [35, 116, 37, 15],
          "saved_attribute_attributes": {
            "valueof": {
      ...
      },
      {
        "box": {
          ...
          "outlettype": ["", "float"],
          "parameter_enable": 1,
          "patching_rect": [424, 280, 44, 15],
          "presentation": 1,
          "presentation_rect": [98, 116, 30, 15],
          "saved_attribute_attributes": {
            "valueof": {
              "parameter_initial": [1],
              "parameter_initial_enable": 1,
      ...
      },
      {
        "box": {
          ...
          "outlettype": ["", ""],
          "parameter_enable": 1,
          "patching_rect": [552, 288, 44, 15],
          "presentation": 1,
          "presentation_rect": [2, 116, 30, 15],
          "saved_attribute_attributes": {
            "valueof": {
      ...
      },
      {
        "box": {
          ...
          "numinlets": 1,
          "numoutlets": 0,
          "patching_rect": [144, 128, 150, 18],
          "presentation": 1,
          "presentation_rect": [72, 115, 32, 18],
          "text": "Rate",
          "textjustification": 0
        }
      }
    ...
    "lines": [
      ...
      {"patchline": {"destination": ["obj-5", 0], "source": ["obj-100", 0]}},
      {"patchline": {"destination": ["obj-5", 0], "source": ["obj-101", 0]}},
      {"patchline": {"destination": ["obj-99", 0], "source": ["obj-103", 0]}},
      {"patchline": {"destination": ["obj-5", 0], "source": ["obj-11", 0]}},
      {"patchline": {"destination": ["obj-297", 0], "source": ["obj-13", 0]}},
      {"patchline": {"destination": ["obj-15", 0], "source": ["obj-14", 0]}},
      {"patchline": {"destination": ["obj-5", 0], "source": ["obj-15", 0]}},
      {"patchline": {"destination": ["obj-20", 0], "source": ["obj-16", 0]}},
      {"patchline": {"destination": ["obj-83", 0], "source": ["obj-17", 0]}},
      ...
      {"patchline": {"destination": ["obj-43", 0], "source": ["obj-19", 0]}},
      ...
      {"patchline": {"destination": ["obj-47", 1], "source": ["obj-28", 0]}},
      ...
      {"patchline": {"destination": ["obj-17", 0], "source": ["obj-46", 0]}},
      ...
      {"patchline": {"destination": ["obj-7", 0], "source": ["obj-6", 0]}},
      ...
      {"patchline": {"destination": ["obj-66", 0], "source": ["obj-71", 0]}},
      ...
      {"patchline": {"destination": ["obj-93", 0], "source": ["obj-92", 0]}},
      {
        "patchline": {
      ...
      {"patchline": {"destination": ["obj-100", 0], "source": ["obj-99", 0]}},
      {"patchline": {"destination": ["obj-101", 0], "source": ["obj-99", 1]}}
    ],
    "parameters": {
      "obj-10": ["Rate", "live.numbox", 0],
      "obj-103": ["Play / Pause", "live.text", 0],
      "obj-14": ["Reset", "live.text", 0],
      ...
      "parameter_overrides": {
        "obj-17::obj-151": {"parameter_longname": "Dimensions[1]"},
