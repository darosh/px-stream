...
<div>
    ...
    <a href="#in-stream"><img src="./docs/media/devices/PX_IN_Stream_(Windows__Syphon).webp" title="IN Stream" width="66"/></a>
    ...
    <a href="#in-stream"><img src="./docs/media/devices/PX_IN_Stream_(Mac__Spout).webp" title="IN Stream" width="66"/></a>
...
<img src="./docs/media/devices/PX_IN_Stream_(Mac__Spout).webp" height="231" title="PX IN Stream (Mac: Spout)" /> <img src="./docs/media/devices/PX_IN_Stream_(Windows__Syphon).webp" height="231" title="PX IN Stream (Windows: Syphon)" />
