...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 544.0, 1040.0, 40.0, 22.0 ],
					"text" : "t i b 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 600.0, 1040.0, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 1264.0, 100.0, 22.0 ],
					"text" : "switch 2",
					"varname" : "pwin_switch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 424.0, 1096.0, 100.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 544.0, 1096.0, 100.0, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 544.0, 1144.0, 100.0, 22.0 ],
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 544.0, 1000.0, 44.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 1040.0, 100.0, 22.0 ],
					"text" : "expr ($i1 == 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 944.0, 100.0, 22.0 ],
					"text" : "r ---go_pop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 999.0, 100.0, 22.0 ],
					"text" : "pak i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 1144.0, 72.0, 22.0 ],
					"text" : "enable $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 944.0, 100.0, 22.0 ],
					"text" : "r ---pwin_gate"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 392.0, 1193.0, 100.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 856.0, 2512.0, 104.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 864.0, 2280.0, 96.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 752.0, 2328.0, 100.0, 36.0 ],
					"saved_object_attributes" : 					{
						"_persistence" : 1
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2448.0, 424.0, 82.0, 22.0 ],
					"text" : "r ---this_bang"
				}
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "recallID", "Button_u693010479" ] ],
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "recallID", "Toggle_u976010564" ] ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.0, 1656.0, 100.0, 22.0 ],
					"text" : "r ---to_pop"
				}
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "recallID", "Toggle_u081010645" ] ],
					"filename" : "jit_gl_ui_toggle.js",
					"id" : "obj-148",
					"linecount" : 8,
					"maxclass" : "newobj",
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "recallID", "Toggle_u890010716" ] ],
					"filename" : "jit_gl_ui_toggle.js",
					"id" : "obj-143",
					"linecount" : 8,
					"maxclass" : "newobj",
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "recallID", "Toggle_u309010787" ] ],
					"filename" : "jit_gl_ui_toggle.js",
					"id" : "obj-135",
					"linecount" : 8,
					"maxclass" : "newobj",
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "recallID", "Toggle_u578010858" ] ],
					"filename" : "jit_gl_ui_toggle.js",
					"id" : "obj-115",
					"linecount" : 8,
					"maxclass" : "newobj",
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "recallID", "Toggle_u881010929" ] ],
					"filename" : "jit_gl_ui_toggle.js",
					"id" : "obj-114",
					"linecount" : 8,
					"maxclass" : "newobj",
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "recallID", "Toggle_u366011000" ] ],
					"filename" : "jit_gl_ui_toggle.js",
					"id" : "obj-111",
					"linecount" : 8,
					"maxclass" : "newobj",
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "recallID", "Toggle_u781011071" ] ],
					"filename" : "jit_gl_ui_toggle.js",
					"id" : "obj-109",
					"linecount" : 8,
					"maxclass" : "newobj",
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "recallID", "Toggle_u417011142" ] ],
					"filename" : "jit_gl_ui_toggle.js",
					"id" : "obj-101",
					"linecount" : 8,
					"maxclass" : "newobj",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 704.0, 944.0, 112.0, 24.0 ],
					"text" : "loadmess label ⛶"
				}
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "recallID", "Button_u890011213" ] ],
					"filename" : "jit_gl_ui_button.js",
					"id" : "obj-70",
					"linecount" : 5,
					"maxclass" : "newobj",
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 704.0, 992.0, 320.0, 77.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "recallID", "Button_u228011296" ] ],
					"filename" : "jit_gl_ui_button.js",
					"id" : "obj-42",
					"linecount" : 5,
					"maxclass" : "newobj",
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 696.0, 840.0, 291.0, 77.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 824.0, 1440.0, 80.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 440.0, 1704.0, 336.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : ";\r\nmax launchbrowser https://github.com/darosh/px-stream#px-stream"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 360.0, 840.0, 30.0, 22.0 ],
					"text" : "- 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 328.0, 712.0, 30.0, 22.0 ],
					"text" : "t f b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 368.0, 768.0, 72.0, 22.0 ],
					"text" : "float 300"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 392.0, 1312.0, 80.0, 60.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 296.0, 168.0 ],
					"sync" : 1,
					"varname" : "pwin_static"
				}
