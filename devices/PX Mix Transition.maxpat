...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 768.0, 216.0, 159.0, 22.0 ],
					"text" : "PX._path.maxpat transitions"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 809.0, 57.0, 22.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 25.0, 752.0, 32.0, 32.0 ],
					"pictures" : [ "refresh.svg", "refresh.svg" ],
					"presentation" : 1,
					"presentation_rect" : [ 44.0, 115.0, 42.0, 16.0 ],
					"remapsvgcolors" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 169.0, 752.0, 32.0, 32.0 ],
					"pictures" : [ "refresh.svg", "refresh.svg" ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 115.0, 42.0, 16.0 ],
					"remapsvgcolors" : 1,
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 809.0, 57.0, 22.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 760.0, 43.0, 22.0 ],
					"text" : "r ---file"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 760.0, 58.0, 22.0 ],
					"text" : "r ---folder"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 169.0, 848.0, 38.0, 22.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 25.0, 848.0, 38.0, 22.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 936.0, 57.0, 22.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 976.0, 129.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 160.0, 336.0, 43.0, 22.0 ],
					"text" : "r ---file"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1072.0, 167.0, 81.0, 22.0 ],
					"text" : "loadmess .jxs"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 943.0, 217.0, 130.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 132.0, 130.0, 19.0 ],
					"varname" : "PX._menu",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 985.0, 104.0, 87.0, 22.0 ],
					"text" : "r ---folder_load"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 943.0, 343.0, 30.0, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 943.0, 409.0, 42.0, 22.0 ],
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 943.0, 376.0, 37.0, 22.0 ],
					"text" : "zl.len"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 767.0, 48.0, 80.0, 22.0 ],
					"text" : "r ---this_bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1000.0, 167.0, 54.0, 22.0 ],
					"text" : "r ---reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 943.0, 513.0, 57.0, 22.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 943.0, 448.0, 37.0, 22.0 ],
					"text" : "zl.rev"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 943.0, 313.0, 39.0, 22.0 ],
					"text" : "zl.join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 959.0, 272.0, 58.0, 22.0 ],
					"text" : "r ---folder"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 943.0, 552.0, 45.0, 22.0 ],
					"text" : "s ---file"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 872.0, 48.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 935.0, 104.0, 32.0, 32.0 ],
					"pictures" : [ "refresh.svg", "refresh.svg" ],
					"presentation" : 1,
					"presentation_rect" : [ 86.0, 115.0, 42.0, 16.0 ],
					"remapsvgcolors" : 1,
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 767.0, 89.0, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 809.0, 128.0, 59.0, 22.0 ],
					"text" : "types .jxs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 935.0, 167.0, 39.0, 22.0 ],
					"text" : "folder"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 160.0, 672.0, 71.0, 22.0 ],
					"text" : "prepend file"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-28::obj-4" : [ "FileName", "FileName", 0 ],
			"obj-28::obj-6" : [ "File Automation", "File", 0 ],
			"obj-28::obj-76" : [ "File", "File", 0 ],
			"obj-360" : [ "Edit", "Edit", 0 ],
