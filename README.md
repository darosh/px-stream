...
<!-- begin: collage -->
<div>
    <a href="#px-shader"><img src="./docs/media/devices/PX_Shader.webp" title="PX Shader" width="224"/></a>
    ...
    <a href="#gen-text"><img src="./docs/media/devices/PX_GEN_Text_(expanded).webp" title="GEN Text" width="126"/></a>
    ...
    <a href="#px-mix-view"><img src="./docs/media/devices/PX_Mix_View_(expanded).webp" title="PX Mix View" width="247"/></a>
    <a href="#fx-color"><img src="./docs/media/devices/PX_FX_Color_(hue).webp" title="FX Color" width="229"/></a>
    ...
    <a href="#px-mix-view"><img src="./docs/media/devices/PX_Mix_View.webp" title="PX Mix View" width="159"/></a>
    ...
    <a href="#px-temp"><img src="./docs/media/devices/PX_TEMP.webp" title="PX TEMP" width="65"/></a>
    <a href="#fx-color"><img src="./docs/media/devices/PX_FX_Color_(gamma).webp" title="FX Color" width="146"/></a>
    <a href="#gen-cos-pattern"><img src="./docs/media/devices/PX_GEN_Cos_Pattern.webp" title="GEN Cos Pattern" width="152"/></a>
</div>
<!-- end: collage -->
