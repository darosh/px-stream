...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 583.0, 1612.0, 55.0, 22.0 ],
					"text" : "pipe 160"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "restore_pwin", "remove_pwin" ],
					"patching_rect" : [ 584.0, 1584.0, 159.0, 22.0 ],
					"text" : "t restore_pwin remove_pwin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 584.0, 1456.0, 55.0, 22.0 ],
					"text" : "pipe 240"
				}
...
,
					"patching_rect" : [ 784.0, 1056.0, 117.0, 22.0 ],
					"text" : "p <VIEW::ENABLE>"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 656.0, 1616.0, 48.0, 22.0 ],
					"text" : "pipe 80"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 584.0, 1504.0, 100.0, 22.0 ],
					"text" : "onebang 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 584.0, 1416.0, 100.0, 22.0 ],
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 584.0, 1384.0, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 584.0, 1352.0, 100.0, 22.0 ],
					"text" : "routepass 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 584.0, 1262.0, 100.0, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 584.0, 1302.0, 100.0, 22.0 ],
					"text" : "gate 2"
				}
...
,
					"patching_rect" : [ 584.0, 1552.0, 120.0, 22.0 ],
					"text" : "p <VIEW::RESET>"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 592.0, 1640.0, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 432.0, 968.0, 62.0, 22.0 ],
					"text" : "r px_bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 416.0, 1504.0, 100.0, 22.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 784.0, 1104.0, 100.0, 22.0 ],
					"text" : "prepend enable"
				}
...
,
					"patching_rect" : [ 600.0, 1072.0, 144.0, 22.0 ],
					"text" : "p <VIEW::PREVIEW>"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 784.0, 1242.0, 324.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 424.0, 1176.0, 339.0, 22.0 ],
					"text" : "jit.gl.render @drawto ---pwin @erase_color 0 0 0 1 @enable 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 784.0, 1176.0, 272.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 424.0, 1224.0, 153.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 864.0, 872.0, 100.0, 22.0 ],
					"text" : "r ---is_enabled"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 592.0, 872.0, 100.0, 22.0 ],
					"text" : "r ---is_collapsed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 712.0, 872.0, 128.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 584.0, 1216.0, 100.0, 22.0 ],
					"text" : "r ---is_windows"
				}
...
, 			{
				"box" : 				{
					...
					"onscreen" : 0,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 448.0, 1312.0, 80.0, 60.0 ],
					"presentation" : 1,
