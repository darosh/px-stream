...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 1136.0, 248.0, 72.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 600.0, 312.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 600.0, 344.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 43.5, 60.5, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 568.0, 536.0, 30.0, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 712.0, 576.0, 30.0, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 760.0, 384.0, 30.0, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 424.0, 376.0, 31.0, 22.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 712.0, 536.0, 30.0, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 712.0, 496.0, 100.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 760.0, 344.0, 84.0, 22.0 ],
					"text" : "prepend scale"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 760.0, 304.0, 56.0, 22.0 ],
					"text" : "r ---scale"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 848.0, 112.0, 528.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 760.0, 416.0, 545.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 568.0, 472.0, 47.0, 22.0 ],
					"text" : "r ---dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 424.0, 344.0, 71.0, 22.0 ],
					"text" : "prepend file"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 424.0, 304.0, 43.0, 22.0 ],
					"text" : "r ---file"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 424.0, 416.0, 204.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 104.0, 248.0, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 264.0, 72.0, 100.0, 50.0 ],
					"pic" : "PX._jpg.svg",
					"presentation" : 1,
...
,
			"parameter_overrides" : 			{
				"obj-15::obj-151" : 				{
					...
					"parameter_modmode" : 0,
					"parameter_range" : [ "2560×1440", "2560×1080", "1920×1080", "1280×720", "720×1280", "640×480", "320×240", "512×512", "480×480", "256×256" ],
					"parameter_type" : 2,
